...
/**
 * Auto of the middle Crater path, given cube is in middle position. TESTING;
 */

//@Autonomous(name = "CraterAuto (B2_MIDDLE)")

public class CraterBranch2 extends LinearOpMode {
