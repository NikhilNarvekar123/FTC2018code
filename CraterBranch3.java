...
/**
 * Auto of the rightmost Crater path, given cube is in right position. TESTING.
 */

//@Autonomous(name = "CraterAuto (B3_RIGHT)")

public class CraterBranch3 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        //Turn counter-clockwise (positive) to left
        imuTurnCounter(0.2,21);
        target = 38;
