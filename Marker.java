...
public class Marker extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        markerServo = hardwareMap.get(CRServo.class,"spinner");
        ...
        while (opModeIsActive()) {
            ...
            if(xCor < 150 && xCor != 0){
                telemetry.addLine("In left quad");
                telemetry.update();
            }else if(xCor > 150 && xCor != 0){
                telemetry.addLine("In middle quad");
                telemetry.update();
            }else {
                telemetry.addLine("In right quad");
                telemetry.update();
            }
